  ...
  return (
    <>
      ...
      <div className='flex flex-row my-6 justify-start items-center gap-x-2 ml-[3.2rem] hover:text-gray-600'>
        ...
        <p className="text-[0.9rem]">Playlist</p>
      </div>
      ...
      <div className='flex flex-row my-6 justify-start items-center gap-x-2 ml-[3.2rem] hover:text-gray-600'>
        ...
        <p className='text-[0.9rem]'>Liked</p>
      </div>
    </div>
    ...
    <div
      ...
      <div className='flex flex-row my-6 justify-start items-center gap-x-2 ml-[3.2rem] mt-16 cursor-pointer hover:text-gray-600 text-white'>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#f1e9e9" viewBox="0 0 256 256">
          <path d="M219.31,108.68l-80-80a16,16,0,0,0-22.62,0l-80,80A15.87,15.87,0,0,0,32,120v96a8,8,0,0,0,8,8h64a8,8,0,0,0,8-8V160h32v56a8,8,0,0,0,8,8h64a8,8,0,0,0,8-8V120A15.87,15.87,0,0,0,219.31,108.68ZM208,208H160V152a8,8,0,0,0-8-8H104a8,8,0,0,0-8,8v56H48V120l80-80,80,80Z" ></path>
        </svg>
        <p className="text-[0.9rem]" onClick={clickHandler}>Home</p>
      ...
      <div className='flex flex-row my-6 justify-start items-center gap-x-2 ml-[3.2rem] hover:text-gray-600 text-white'>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#f1e9e9" viewBox="0 0 256 256">
          <path d="M230.92,212c-15.23-26.33-38.7-45.21-66.09-54.16a72,72,0,1,0-73.66,0C63.78,166.78,40.31,185.66,25.08,212a8,8,0,1,0,13.85,8c18.84-32.56,52.14-52,89.07-52s70.23,19.44,89.07,52a8,8,0,1,0,13.85-8ZM72,96a56,56,0,1,1,56,56A56.06,56.06,0,0,1,72,96Z"></path>
        </svg>
        <Link to="/profile" className="text-[0.9rem]">
    Profile
</Link>
