...
const Navbar = () => {
  ...
  return (
    <div className="h-[6.5rem] w-full flex md:flex-row md:justify-between  items-center bg-transparent pl-[20%] md:px-10 ">
      <p className=" lg:text-xl md:text-xl  md:flex hidden text-slate-300">
        Playing&nbsp;for <span className="font-bold text-indigo-500">&nbsp; {name}👋🏻</span>
      </p>
      <div className="flex lg:justify-end lg:gap-x-4 md:gap-x-2 md:justify-start justify-evenly  items-center  md:w-7/12 lg:w-6/12 w-8/12 md:ml-0 ml-6 lg:mr-[12rem] md:mr-[1.5rem]">
        ...
        <div  onClick={logoutHandler} className='md:mr-[4rem]'>
        <img src='logo512.png' alt='logo' className='lg:w-[2.5rem] lg:h-[2.5rem] md:w-[2.5rem] md:h-[2.5rem]  w-8 h-8' />
        </div>
      </div>
    </div>
  )
